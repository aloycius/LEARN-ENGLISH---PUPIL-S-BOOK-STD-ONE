# Learn English Pupil’s Book Standard One (Kiswahili Medium Schools) — ADT Bundle Reference
...
**Learn English Pupil’s Book Standard One (Kiswahili Medium Schools)** — This is an English-language beginner textbook from Tanzania, published by the Tanzania Institute of Education for Standard One pupils in Kiswahili-medium primary schools. It introduces very early English skills through listening, speaking, phonics, simple reading, numbers, times of day, greetings, self-introduction, and polite expressions, so it is aimed at young early-primary learners around ages 6–7. The book uses a highly activity-based, oral and participatory approach with songs, repetition, picture naming, and everyday school and home contexts to build basic communication and sound-letter awareness.
...
```
LEARN-ENGLISH---PUPIL-S-BOOK-STD-ONE-COMMISSIONER/
├── adt/                              # THE WEB APP
...
├── LEARN-ENGLISH---PUPIL-S-BOOK-STD-ONE-COMMISSIONER.db                    # SQLite database (pipeline state)
├── LEARN-ENGLISH---PUPIL-S-BOOK-STD-ONE-COMMISSIONER.pdf                   # Original source PDF
...
```json
{
  ...
  "gl001": "action",
  "gl001_def": "something that a person or animal does.",
  "qz001_que": "Which animal says moo-moo in the song?",
  "qz001_o0": "1) cow",
  "qz001_o0_exp": "✅ Correct! In the song, cows make the sound moo-moo."
}
```
...
```json
{
  "action": {
    "word": "action",
    "definition": "something that a person or animal does.",
    "variations": ["action","actions"],
    "emoji": "🏃✋"
  }
}
```
...
```json
{
  "title": "Learn English Pupil’s Book Standard One (Kiswahili Medium Schools)",
  "bundleVersion": "1",
  "languages": {
    "available": [
      "en"
...
<section role="activity" data-section-type="activity_quiz" data-id="qz001"
    ...
    <p data-id="qz001_que">Which animal says moo-moo in the song?</p>

    <label data-activity-item="qz001_o0"
           data-explanation="✅ Correct! In the song, cows make the sound moo-moo." data-explanation-id="qz001_o0_exp">
        <input type="radio" name="qz001" value="qz001_o0" class="sr-only" />
        <span data-id="qz001_o0">1) cow</span>
    </label>
    <!-- more options... -->
</section>
...
| Original PDF | `LEARN-ENGLISH---PUPIL-S-BOOK-STD-ONE-COMMISSIONER.pdf` |
| Pipeline database | `LEARN-ENGLISH---PUPIL-S-BOOK-STD-ONE-COMMISSIONER.db` (SQLite) |
